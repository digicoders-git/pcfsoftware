	...
	<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
		...
		<div class="app-content content">
			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
						<h5><a href="<?= base_url($this->data->controller); ?>/Dashboard"><?= $this->data->title; ?></a> / DIVIDEND OUTSTANDING A/C</h5>
					
                        
                        <br/>

                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/DividentOutstanding'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">DIVIDEND OUTSTANDING A/C
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr <?php if(isset($fyyear)) { } else {?> style="display:none; " <?php } ?> >
														<td></td>
														<td colspan="3">
															<span>BY OPENING BAL.B/F <?= date("d/m/Y",strtotime($start_date)) ?>
														...
														<td>
															...
															{
																$query = $this->db->where(['entrycode'=>'DIVOUT','financial_year'=>"2022-2023"])->get('tbl_balance');
																$data['list'] = $query->result();
																$Opening_Bal = $data['list'][0]->amount;
															}
															else if($fyyear=="2024-2025")
															{
																$query = $this->db->where(['entrycode'=>'DIVOUT','financial_year'=>"2023-2024"])->get('tbl_balance');
																$data['list'] = $query->result();
																$Opening_Bal = $data['list'][0]->amount;
															}
															// echo $Opening_Bal;
													...
													<tr <?php if(isset($fyyear)) { echo ""; } else { echo 'style="display:none;"'; } ?> style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															<b><?php 
																...
																$query = $this->db->where(['entrycode'=>'DIVOUT','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{
																	$data['list'] = $query->result();

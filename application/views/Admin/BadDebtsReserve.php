	...
	<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
		...
		<div class="app-content content">
			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
						<h5><a href="<?= base_url($this->data->controller); ?>/Dashboard"><?= $this->data->title; ?></a> / BAD DEBTS RESERVE FUND</h5>

                        
                        <br/>

                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/BadDebtsReserve'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">BAD DEBTS RESERVE FUND
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														<td></td>
														<td colspan="3">
															<span>BY OPENING BAL.B/F 01/04/2023 
				...
				$query = $this->db->where(['entrycode'=>'BADRES','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

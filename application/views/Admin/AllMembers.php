							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title" id="basic-layout-form-center">All Members</h4><hr>
									</div>
											...
											<table class="table table-striped table-bordered table-responsive" id="table_id" >
												...
												<tbody>	
													...
													<tr>
														...
														<td></td>	
														<td></td>	
														<td><span>&#8377;</span><?= $total_savings; ?></td>	
														<td><span>&#8377;</span><?= $total_loan; ?></td>	
														<td><span>⬤</span> <?= $total_shares; ?></td>	
														<td></td>	
														<td></td>	
														<td></td>	
													</tr>	

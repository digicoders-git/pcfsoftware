			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
                        ...
                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/SavingAccount'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">SAVING ACCOUNT
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														<td></td>
														<td colspan="3">
															<span>BY OPENING BAL.B/F 01/04/2024
														...
														<td>
															<?php 
																// $Opening_Bal = 17846476.67; 
																// $Opening_Bal = 19973171.93; 
																// $Opening_Bal = 19972671.93; 
																$Opening_Bal = 21078943.60; 
																echo $Opening_Bal;
															?>
														</td>
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															...
															$type = '';
																...
																$query = $this->db->where(['entrycode'=>'SAVACC','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

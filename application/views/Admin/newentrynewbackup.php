												...
												<div class="row justify-content-md-center">
													<div class="col-md-12">
														...
														<?php
															...
															<?php
																$list = $this->db->query("select * from members where ho_status='true' ")->result();
																{
																	if(!empty($list))
																	{
																		$srno = 1;
																		...
																		<div class="form-row ">
																			...
																			<div class="col-md-3 mb-3">
																				<label>Loan</label>
																				<input type="text" class="form-control credit entry_credit" name="debit[]" placeholder="Loan">
																			</div>
																			
																			<div class="col-md-3 mb-3">
																				<label>Saving</label>
																				<input type="text" class="form-control credit entry_credit" name="credit[]" placeholder="Saving">
																			</div>
																		</div> 

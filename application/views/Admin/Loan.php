                                       ...
                                       <div class="form-body">
                                          <div class="form-row">
                                             ...
                                             <div class="form-group col-md-2" >
                                                ...
                                                <input type="date" value="<?php if(!empty($fromdate))
                                                   {
                                                   	echo $fromdate;
                                                   }?>" name="date1" class="form-control"  required>
                                             </div>
                                             <div class="form-group col-md-2"  >
														...
														<table style="width:100%">
															...
															<tbody>
																...
																<tr>
																	...
																	<td colspan="3" >
																		...
																		<?php
																			...
																			// $this->db->where('pf_number', $item->pf_no)->update('members',array('loan_interest1'=>$final_interest));
																...
																<tr style="border-top:dotted;border-bottom:dotted;">
																	<td colspan="3">
																		<b><span>T O T A L = (As on <?php echo $newtodate1;?>)</span></b>	
																	</td>
																	<td>
																	</td>
																	<td>

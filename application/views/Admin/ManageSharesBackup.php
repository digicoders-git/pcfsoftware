							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title" id="basic-layout-form-center">All SHARES</h4><hr>
									</div>
											...
											<table class="table table-striped table-bordered table-responsive" id="table_id" >
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 115.047px;">Shares Account Balance</th>
													...
													<?php
														...
														foreach ($list as $item)
														{
															...
															<tr role="row" class="even">
																...
																<td ><?= $item->name; ?></td>
																<td width="16%"><span>⬤</span> <?= $item->shares; ?></td>
																<td width="12%" >

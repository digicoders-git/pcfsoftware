	...
	<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
		...
		<div class="app-content content">
			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
						<h5><a href="<?= base_url($this->data->controller); ?>/Dashboard"><?= $this->data->title; ?></a> / SUNDRY DEBTORS (DIVEDEND A/C)</h5>
					
                        
                        <br/>

                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/SundryDebtors'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">SUNDRY DEBTORS (DIVEDEND A/C)
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														<td></td>
														<td colspan="3">
															<span>TO OPENING BAL.B/F 01/04/2024
														...
														<td>
															<?php 
																$Opening_Bal = 10593192.00; 
																$Opening_Bal = 11782879.00;
																$Opening_Bal = 12947369.00;
																echo $Opening_Bal;
															?>
														</td>
														<td>0.00</td>
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															<b><?php 
																...
																$query = $this->db->where(['entrycode'=>'DIVACC','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

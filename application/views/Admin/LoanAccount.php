			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
                        ...
                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/LoanAccount'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">Loan Account
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														...
														<td>
															<?php 
																// $Opening_Bal = 34647541.81; 
																// $Opening_Bal = 41745066.72; 
																// $Opening_Bal = 41750066.72; 
																$Opening_Bal = 43205761.99; 
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															...
															$type = '';
																...
																$query = $this->db->where(['entrycode'=>'LONACC','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

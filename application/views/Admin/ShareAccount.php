			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
                        ...
                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/ShareAccount'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">SHARE ACCOUNT
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														...
														<td>
															<?php 
																// $Opening_Bal = 8209081.00; 
																// $Opening_Bal = 8603011.00; 
																$Opening_Bal = 8380291.00; 
																echo $Opening_Bal;
															?>
														</td>
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															...
															$type = '';
																...
																$query = $this->db->where(['entrycode'=>'SHAACC','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

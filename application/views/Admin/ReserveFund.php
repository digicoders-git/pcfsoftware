	...
	<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
		...
		<div class="app-content content">
			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
						<h5><a href="<?= base_url($this->data->controller); ?>/Dashboard"><?= $this->data->title; ?></a> / RESERVE FUND A/C</h5>
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">RESERVE FUND A/C
											</h4>
											<!--table start here -->
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															<b><?php 
																...
																$query = $this->db->where(['entrycode'=>'RESFUN','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

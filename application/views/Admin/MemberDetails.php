						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form-center">Member Details</h4>
									<hr>
								</div>
								<div class="card-content collapse show " style="margin-top:-40px;">
									<div class="card-body">
										<!--Form start here -->
										<form id="memberform" action="<?php echo base_url('Admin/MemberDetails'); ?>" method="post">
													...
													<div class="form-body">
														<div class="form-row">
															<div class="form-group col-md-2">
																...
																<input type="text" minlength="6" maxlength="6" class="form-control" name="pf_no" placeholder="PF Number" value="<?php echo set_value('pf_no'); ?>" required>
															</div>
															<div class="form-group col-md-2">
																...
																<select id="disabledSelect" class="form-select form-control" name="entrycode" required>
																	<option selected disabled value="">Choose GL-HEAD</option>
														...
														<tbody>
															<?php
																...
																foreach ($list as $item)
																{
																	...
																	$savinginterest =$memberdata->saving_interest;
								...
								$date = date('t/m/Y', strtotime('+1 month', strtotime($date_time)));
																...
																<td colspan="3">
																	...
																	<?php
																		if($item->entrycode=="LONACC")
																		{
																			echo number_format($totalinterest, 2, '.', '');
																		}
																		else if($item->entrycode=="SAVACC")
																		{
																			echo number_format($savinginterest, 2, '.', '');
																		}
																		else 
																		{
																			echo "0.00"; 
															...
															<tr style="border-top:dotted;border-bottom:dotted;">
																<td colspan="3">
																	<span>T O T A L = (As on <?php echo date('t/m/Y');?>)</span>	
																</td>
																<td>
																	<!--Interest 
																		<?//php
																...
																<td>
																	<?php
																		...
																		{
																			if($item->entrycode=="SAVACC")
																			{
																				echo number_format(($totalcredit-$totaldebit)+$savinginterest, 2, '.', '')." Cr."; 
																			}
																			elseif($item->entrycode=="SHAACC")
																			{

			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
                        ...
                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/EntertainmentExpenses'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">ENTERTAINMENT EXPENSES A/C
											</h4>
											<!--table start here -->
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															...
															$type = '';
																...
																$query = $this->db->where(['entrycode'=>'ENTEXP','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

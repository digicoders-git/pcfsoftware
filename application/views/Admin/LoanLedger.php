	...
	<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
		...
		<div class="app-content content">
			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
						<h5><a href="<?= base_url($this->data->controller); ?>/Dashboard"><?= $this->data->title; ?></a> / INCOME FROM INTEREST</h5>
					
                        
                        <br/>

                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/LoanLedger'); ?>" method="post">
							...
							<div class="col-md-12">
								<div class="card" id="printableArea">
									<div class="card-header">
										<h4 class="card-title" id="basic-layout-form-center">Income From Interest<span> (As on <?php echo date('31/03/2025');?>)</span></h4>
										<br>
									</div>
												...
												<tbody>
													<?php
														...
														foreach ($list as $item)
														{
															...
															if(!empty($item->loan_interest2))
															{
																$total_loan_int+=$item->loan_interest2;
															}
														...
														<tr>
															...
															<td>
																<?php 
																	// $item->credit
																	// if(!empty($item->loan_interest2))
																	if($item->loan_interest2>0)
																	{
																		// echo number_format($item->loan, 2, '.', '');
																		echo number_format($item->loan_interest2, 2, '.', '');
																	}
																	else 
																	{
																		echo "0.00";
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<?php
															...
															'entrycode' => 'INCINT',
															'type' => $type,
															'amount' => $total_loan_int,
															'date' => date('Y-m-d'),
															'time' => date('h:i A'),
															'financial_year' => $financial_year,
															];
															
															$query = $this->db->where(['entrycode'=>'INCINT','financial_year'=>$financial_year])->get('tbl_balance');
															if ($query->num_rows())
															{

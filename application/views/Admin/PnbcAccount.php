			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
                        ...
                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/PnbcAccount'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">PUNJAB NATIONAL BANK C/A
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														...
														<td>
															<?php 
																// $Opening_Bal = 1062330.16; 
																// $Opening_Bal = 119492.22; 
																// $Opening_Bal = 113992.22; 
																//$Opening_Bal = 638866;
																$Opening_Bal = 637426.93;
																echo $Opening_Bal;
															?>
														</td>
														<td>0.00</td>
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															...
															// $type = '';
																...
																$query = $this->db->where(['entrycode'=>'PNBC/A','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

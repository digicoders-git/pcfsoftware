						...
						<div class="col-md-12">
							<div class="card" id="printableArea">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form-center">Shares Ledger <span> (As on <?php echo date('d/m/Y');?>)</span></h4>
									<br>
								</div>
													...
													<tr>
														...
														<td>
															<?php 
																...
																{
																	echo number_format($item->savings, 2, '.', '');
																}
																else 
																{
																	echo "0.00";
														...
														<td>
															<?php 
																...
																{
																	echo number_format($item->shares, 2, '.', '');
																}
																else 
																{
																	echo "0.00";

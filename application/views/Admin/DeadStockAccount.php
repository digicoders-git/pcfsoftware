	...
	<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
		...
		<div class="app-content content">
			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
						<h5><a href="<?= base_url($this->data->controller); ?>/Dashboard"><?= $this->data->title; ?></a> / DEAD STOCK A/C</h5>
					
                        
                        <br/>

                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/DeadStockAccount'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">DEAD STOCK A/C
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														<td></td>
														<td colspan="3">
															<span>TO OPENING BAL.B/F 01/04/2025 
														...
														<td>
															<?php 
																$Opening_Bal = 37661.00;  // 2022-23
																$Opening_Bal = 22597.00;  // 2023-24
																$Opening_Bal = 13559.00;  // 2023-24
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															<b><?php
																$debitSum = (float)$Opening_Bal+$total_Debit_value; 
														...
														<td>
															<b><?php 
																...
																if(isset($fyyear)) 
																{																	
																	$query = $this->db->where(['entrycode'=>'DEASTO','financial_year'=>$financial_year])->get('tbl_balance');
																	if ($query->num_rows())
																	{

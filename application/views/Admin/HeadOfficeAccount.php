			...
			<div class="content-wrapper">
				...
				<div class="row mb-2">
					<div class="col-12">
                        ...
                        <!--Form start here -->
                        <form action="<?php echo base_url('Admin/HeadOfficeAccount'); ?>" method="post">
								...
								<div class="card" >
									...
									<div class="card-content collapse show " style="margin-top:-40px;">
										<div class="card-body" id="printableArea">
											<h4 class="card-title" id="basic-layout-form-center">P.C.F. HEAD OFFICE A/C
											</h4>
											<!--table start here -->
											<table style="width:100%">
												...
												<tbody>
													<tr style="">
														...
														<td>
															<?php 
																// $Opening_Bal = 4291781.87; 
																// $Opening_Bal = 1310179.87; 
																$Opening_Bal = 1115851.92; 
																echo $Opening_Bal;
															?>
														</td>
														<td>0.00</td>
													...
													<tr style="border-top:dotted;border-bottom:dotted;">
														...
														<td>
															...
															$type = '';
																...
																$query = $this->db->where(['entrycode'=>'PCFHEA','financial_year'=>$financial_year])->get('tbl_balance');
																if ($query->num_rows())
																{

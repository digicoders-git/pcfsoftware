<?php 
	...
	class Admin extends Admin_Controller
	{
		...
		public function getFY($date1, $date2) 
		{
			// Validate the dates
			...
			if (!$startDate || !$endDate || $startDate > $endDate) {
				return '';  // Return blank string for invalid dates
			}

			// Get the financial year based on the start date
			...
			// Get the financial year based on the end date
			...
			if ($endMonth > 3) {
				...
				$financialYearEnd = $endYear - 1;
			}

			// Check if both dates are in the same financial year
			if ($financialYearStart === $financialYearEnd) {
				return $financialYearStart . '-' . ($financialYearStart + 1);
			} else {
				return '';  // Dates are not in the same financial year
			}
		}
		...
		// old function for savings
		public function Savings1()
		{
            ...
            } else if($fyyear=="2023-2024")
            {
                $start_date = "2023-04-01";
                $end_date = "2024-03-31";

            } else if($fyyear=="2024-2025")
            {
			...
			if(!empty($this->input->post()))
			{
				...
				if($t_date2>$n_f_date){
                    ...
                    $q2 = "SELECT * FROM tbl_entry
					WHERE pf_no='$pf_no' and entrycode='$entrycode' and date_time BETWEEN '$n_fear' and '$t_date2' ORDER BY date_time ASC, entry_type ASC";
					$data['list_2'] = $this->db->query($q2)->result();
		...
		public function Savings()
		{
			...
			*/
			...
			if(!empty($this->input->post()))
			{
				...
				$data["list_members"] = $this->db->order_by("pf_number", "ASC")->where(array('is_status' =>'true', 'pf_number' => $pf_no ))->get("members")->result();
				$data["start"]=$f_date1;
				$data["newtodate"]=$f_date2;
				$data["entrycode"]=$entrycode;
				$data["status"] = 'true';
				
				$data["fyyear"] = $this->getFY($fromdate, $todate);
		...
		public function Loan1()
		{
			...
			if(!empty($this->input->post()))
			{
				...
				if($t_date2>$n_f_date){
					...
					WHERE pf_no='$pf_no' and entrycode='$entrycode' and date_time BETWEEN '$n_fear' and '$t_date2' ORDER BY date_time ASC, entry_type ASC";
					$data['list_2'] = $this->db->query($sql2)->result(); 
		...
		public function Loan()
		{
			...
			*/
			...
			if(!empty($this->input->post())){
				...
				$data["fyyear"] = $this->getFY($f_date1, $t_date2);
			}
			else 
			{
			 	$data["status"] = 'false';
		...
		public function SavingsLedger()
		{
			...
			$query = $this->db->query("SELECT * FROM `members` where saving_interest1!=0 order by pf_number asc");
		...
		// my subsidiarycode start here new 
		...
		public function SubsidiarySavingsLedger()
		{
			...
			if(!empty($this->input->post())){
				...
				$data["list_members"] = $this->db->order_by("pf_number", "ASC")->where('is_status', 'true')->where("pf_number IS NOT NULL AND pf_number != ''")->get("members")->result();
		...
		// my subsidiarycode end here new 
		...
		public function TrialBalance()
		{
			...
			$query = $this->db->order_by("entrycode", "ASC")->where("financial_year","2023-2024")->get($this->data->table);
			$data["list"] = $query->result();
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='LONACC' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='PNBC/A' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='SAVACC' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{ 
			...
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '$fromdate' AND '$todate' AND entrycode='ADVTAX' order by `date_time` ASC");
		...
		public function BadDebtsReserve()
		{
			...
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '$fromdate' AND '$todate' AND entrycode='BADRES' order by `date_time` ASC");
		...
		public function CashInHand()
		{
			...
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '$fromdate' AND '$todate' AND (entrycode='PNBC/A' AND entrydesc LIKE '%WIT%') OR (entrycode='PNBC/A' AND entrydesc LIKE '%CASH%') OR entrycode='CONCHA' OR entrycode='BALSOC' OR entrycode='ENTEXP' OR  entrycode='PRISTA' OR (entrycode='DIVOUT' AND entrydesc LIKE '%CASH%') order by `date_time` ASC");
		...
		public function BankChargeAccount()
		{
			...
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='BANKCH' order by `date_time` ASC");
		...
		public function ConveyanceCharge()
		{
			...
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='CONCHA' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='MISCEL' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='DEASTO' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='DEPCHA' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='DIVACC' order by `date_time` ASC");
		...
		public function LoanLedger()
		{
			...
			$query = $this->db->query("SELECT * FROM `members` where loan_interest1>0 order by pf_number asc");
		...
		public function DividentOutstanding()
		{
			...
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='DIVOUT' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='INVFOR' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='INVSHA' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='OTHRES' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='PRISTA' order by `date_time` ASC");
		...
		{
			// $query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='PROLOS' order by `date_time` ASC");
			
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2024-03-31' AND entrycode='PROLOS' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='RESFUN' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='SBOPCA' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2023-04-01' AND '2024-03-31' AND entrycode='SECFUN' order by `date_time` ASC");
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='SHAACC' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='PCFHEA' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='SALACC' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='ENTEXP' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='LEGEXP' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
		...
		{
			$query = $this->db->query("SELECT * FROM `tbl_entry` WHERE date_time BETWEEN '2024-04-01' AND '2025-03-31' AND entrycode='MEMFEE' order by `date_time` ASC");
			$debit_amount = 0;
			$credit_amount = 0;
			foreach($query->result() as $fixed_date){
